 import { Box, useBreakpointValue, keyframes } from '@chakra-ui/react';
 ...
 const DivHeroProgramador = () => {
  ...
  const circuloHero = {
   ...
   const customCircleStyles = css`
  ${circuloHero}
  animation: ${flickerAnimation} 2.5s linear infinite;
 `
  return (
   <Box
